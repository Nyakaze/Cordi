...
public class NotificationManager
{
    ...
    public void Draw()
    {
        ...
        using (ImRaii.PushStyle(ImGuiStyleVar.WindowRounding, 8f))
        using (ImRaii.PushStyle(ImGuiStyleVar.WindowBorderSize, 1f))
        using (ImRaii.PushColor(ImGuiCol.WindowBg, _theme.CardBg))
        using (ImRaii.PushColor(ImGuiCol.Border, _theme.WindowBorder))
        using (ImRaii.PushColor(ImGuiCol.Text, _theme.Text))
        {
            lock (_activeNotifications)
            {
